...
#cursor.execute('''INSERT INTO Sittevogn VALUES (1, " SJ-sittevogn-1", 1, )''')
#cursor.execute('''INSERT INTO Sittevogn VALUES (2, " SJ-sittevogn-1", 1, )''')
#cursor.execute('''INSERT INTO Sittevogn VALUES (3, " SJ-sittevogn-1", 1, )''')
#cursor.execute('''INSERT INTO Sittevogn VALUES (4, " SJ-sittevogn-1", 1, )''')
